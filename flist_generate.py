...
parser.add_argument('--folder_path', default='./imagenet', type=str,
                    help='The folder path')
parser.add_argument('--train_filename', default='./imagenet/train_shuffled.flist', type=str,
                    help='The output filename.')
parser.add_argument('--validation_filename', default='./imagenet/validation_static_view.flist', type=str,
                    help='The output filename.')
